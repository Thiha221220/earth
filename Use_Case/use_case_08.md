<h1 style="font-family: 'Times New Roman'">USE CASE 8 : The top N populated cities in a district where N is provided by the user.</h1>
...
<h3 style="font-family: 'Times New Roma![img.png](img.png)n'; font-size: 20px">Scope</h3>
...
<span style="font-family: 'Times New Roman'; font-size: 18px;"> A report is available for report manager to provide the user requests for displaying the top populated of cities in a district.</span>
...
<li style="font-family: 'Times New Roman'; font-size: 18px;">The system provides a report for top N population information of cities in a district. </li> 
</ol>
...
<dd>The system informs the top N population of cities in a district by the users requests.</dd>
</dl>
