<h1 style="font-family: 'Times New Roman'">USE CASE 16 : Produce a Report on the all the cities in a continent organised by largest population to smallest</h1>
...
<span style="font-family: 'Times New Roman'; font-size: 18px;"> As a report manager, we want to produce a report on the all cities in a continent so that we can support the population reporting of all cities in a continent.</span>
...
<span style="font-family: 'Times New Roman'; font-size: 18px;">We know the role. Work Database contains current population data of cities in a continent.</span>

<h3 style="font-family: 'Times New Roman'; font-size: 20px">Success End Condition</h3>
<span style="font-family: 'Times New Roman'; font-size: 18px;"> A report is available for report manager to provide the population of cities in a continent.</span>
...
<ol>
<li style="font-family: 'Times New Roman'; font-size: 18px;">The report manager asks the city information in a continent by the population.</li>  
...
<dd>The system informs the population of the cities in a continent.</dd>
</dl>
