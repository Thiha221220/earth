<h1 style="font-family: 'Times New Roman'">USE CASE 14 : The top N populated cities in a region where N is provided by the user.</h1>
...
<span style="font-family: 'Times New Roman'; font-size: 18px;"> As a report manager, we want to produce a report on the cities in a region by the users so that we can support the population of cities in a region.</span>
...
<span style="font-family: 'Times New Roman'; font-size: 18px;"> A report is available for report manager to provide the user requests for displaying the top populated of cities in a region.</span>
...
<li style="font-family: 'Times New Roman'; font-size: 18px;">The system provides a report for top N population information of cities in a region. </li> 
</ol>
...
<dd>The system informs the top N population of cities in a region by the users requests.</dd>
</dl>
