<h1 style="font-family: 'Times New Roman'">USE CASE 18 : Produce a Report on the all the capital cities in a region organised by largest population to smallest</h1>
...
<span style="font-family: 'Times New Roman'; font-size: 18px;"> As a report manager, we want to produce a report on the all capital cities in a region so that we can support the population reporting of all capital cities in a region.</span>
...
<span style="font-family: 'Times New Roman'; font-size: 18px;">We know the role. Work Database contains current population data of capital cities in a region.</span>

<h3 style="font-family: 'Times New Roman'; font-size: 20px">Success End Condition</h3>
<span style="font-family: 'Times New Roman'; font-size: 18px;"> A report is available for report manager to provide the population of capital cities in a region.</span>
...
<dd>The system informs the population of the capital cities in a region.</dd>
</dl>
