<h1 style="font-family: 'Times New Roman'">USE CASE 26: The population of the world should be accessible to the organisation.</h1>
...
<span style="font-family: 'Times New Roman'; font-size: 18px;"> As a report manager, we want to produce a report on the population of the world so that we can support the population reporting of the population of the world.</span>
...
<span style="font-family: 'Times New Roman'; font-size: 18px;">We know the role. Work Database contains current population data of the world.</span>

<h3 style="font-family: 'Times New Roman'; font-size: 20px">Success End Condition</h3>
<span style="font-family: 'Times New Roman'; font-size: 18px;"> A report is available for report manager to provide the population of the world.</span>
...
<ol>
<li style="font-family: 'Times New Roman'; font-size: 18px;">The report manager asks the world information by the population.</li>  
<li style="font-family: 'Times New Roman'; font-size: 18px;">The system retrieves the data of the world from the database.</li>
<li style="font-family: 'Times New Roman'; font-size: 18px;">The system provides a report for the world. </li> 
</ol>
...
<dd>The system informs the population of the world.</dd>
</dl>
