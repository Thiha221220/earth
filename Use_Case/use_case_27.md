<h1 style="font-family: 'Times New Roman'">USE CASE 27: The population of the continent should be accessible to the organisation.</h1>
...
<span style="font-family: 'Times New Roman'; font-size: 18px;"> As a report manager, we want to produce a report on the population of the continent so that we can support the population reporting of the population of the continent.</span>
...
<span style="font-family: 'Times New Roman'; font-size: 18px;">We know the role. Work Database contains current population data of the continent.</span>

<h3 style="font-family: 'Times New Roman'; font-size: 20px">Success End Condition</h3>
<span style="font-family: 'Times New Roman'; font-size: 18px;"> A report is available for report manager to provide the population of the continent.</span>
...
<ol>
<li style="font-family: 'Times New Roman'; font-size: 18px;">The report manager asks the continent information by the population.</li>  
<li style="font-family: 'Times New Roman'; font-size: 18px;">The system retrieves the data of the continent from the database.</li>
<li style="font-family: 'Times New Roman'; font-size: 18px;">The system provides a report for the continent. </li> 
</ol>
...
<dd>The system informs the population of the continent.</dd>
</dl>
