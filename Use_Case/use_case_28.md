<h1 style="font-family: 'Times New Roman'">USE CASE 28: The population of the Region should be accessible to the organisation.</h1>
...
<span style="font-family: 'Times New Roman'; font-size: 18px;"> As a report manager, we want to produce a report on the population of the Region so that we can support the population reporting of the population of the Region.</span>
...
<span style="font-family: 'Times New Roman'; font-size: 18px;">We know the role. Work Database contains current population data of the Region.</span>

<h3 style="font-family: 'Times New Roman'; font-size: 20px">Success End Condition</h3>
<span style="font-family: 'Times New Roman'; font-size: 18px;"> A report is available for report manager to provide the population of the Region.</span>
...
<ol>
<li style="font-family: 'Times New Roman'; font-size: 18px;">The report manager asks the Region information by the population.</li>  
<li style="font-family: 'Times New Roman'; font-size: 18px;">The system retrieves the data of the Region from the database.</li>
<li style="font-family: 'Times New Roman'; font-size: 18px;">The system provides a report for the Region. </li> 
</ol>
...
<dd>The system informs the population of the Region.</dd>
</dl>
