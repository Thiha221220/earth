...
public class AppTest {
    ...
    @Test
    void displayCountry() {
        ArrayList<Country> coucons =  new ArrayList<>();
        Country cit = new Country("CHN","China", "Asia", "Eastern Asia", Math.round(1.27755802E9), "Peking");
        coucons.add(cit);
    ...
    void displayCountryPopLSRegion() {
        ArrayList<Country> coucons =  new ArrayList<>();
        Country cit = new Country("MMR","Myanmar", "Asia", "Southeast Asia", Math.round(4.5611E7), "Rangoon (Yangon");
        coucons.add(cit);
    ...
    void displayCouCon() {
        ArrayList<Country> coucons =  new ArrayList<>();
        Country cit = new Country("ITA","Italy", "Europe", "Southern Europe", Math.round(5.768E7), "Roma");
        coucons.add(cit);
    ...
    void displayTopCountryPop() {
        ArrayList<Country> coucons =  new ArrayList<>();
        Country cit = new Country("JPN","Japan", "Eastern Asia", "Asia",  Math.round(1.26714E8), "Tokyo");
        coucons.add(cit);
    ...
    void displayTopCouContPop() {
        ArrayList<Country> coucons =  new ArrayList<>();
        Country cit = new Country("CAN","Canada", "North America", "North America", Math.round(3.1147E7), "Ottawa");
        coucons.add(cit);
    ...
    void displayCntCitynotCity() {
        ArrayList<Population> coucons =  new ArrayList<>();
    ...
    void displayCntCitynotCitySize() {
        ArrayList<Population> cities =  new ArrayList<>();
        Population cit = new Population("Afghanistan",22720000,2332100,20387900);
        cities.add(cit);
        assertEquals(1,cities.size());
    }
